...
<div class="box box-primary fs-5 text-center  ">
  ...
  <img src="{{ $gym->image_path }}" class="card-img-top " width="200rem">
    <ul class="list-group list-group-flush fs-5">
      ...
      <li class="list-group-item "> Email {{$gym->city_manager->email}}</li>
      <h3>Gym managers</h3>
      @foreach($gym->gym_managers as $gym_manager)
      <li class="list-group-item ">Name  {{$gym_manager->name}}</li>
      <li class="list-group-item ">email  {{$gym_manager->email}}</li>
      @endforeach
    </ul>
  </div>
