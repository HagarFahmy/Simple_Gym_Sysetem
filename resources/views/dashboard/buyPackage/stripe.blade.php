        ...
        <div class="col-8 offset-2">
            ...
            <div class="card card-info my-3">
                <div class="card-header py-3">
                    <img src="{{ asset('dashboard/dist/img/credit/Credit-Card-Icons.jpg') }}" width="100%">
                </div>
                <div class="card-body">
                    <form action="{{ route('dashboard.single.charge') }}" method="POST" id="subscribe-form">
                        ...
                        <div class="form-group text-center">
                            <button id="card-button" data-secret="{{ $intent->client_secret }}"
                                class="btn btn-lg btn-info text-white btn-block">Confirm Payment Process</button>
                        </div>
                    </form>
                </div>
            </div>
